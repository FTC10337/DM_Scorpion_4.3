/*
 *  AutoMode: testing Gyro in Autonomous mode
 */
...
@Autonomous(name="Gyro TEST", group="DarkMatter2019")
//@Disabled
public class GyroTEST extends LinearOpMode {
    ...
    static final double     P_DRIVE_COEFF_2         = 0.35;  // Intenionally large so robot "wiggles" around the target setpoint while driving
    ...
    public void runOpMode() throws InterruptedException {
        ...
        //scorpion.driveTrain.setMode(DcMotor.RunMode.RUN_WITHOUT_ENCODER);
        ...
        //lowering the robot
        scorpion.liftStinger.lift.setPower(-0.5);
        sleep(3000);
                        ...
                        if (updatedRecognitions.size() == 3) {
                            ...
                            if (goldMineralX != -1 && silverMineral1X != -1 && silverMineral2X != -1) {
                                if (goldMineralX < silverMineral1X && goldMineralX < silverMineral2X) {
                                    ...
                                    scorpion.liftStinger.lift.setPower(0.8);
                                    sleep(1900);
                                    scorpion.liftStinger.lift.setPower(0);
                                    sleep(1000);
    ...
    private double checkDirection() {
        ...
        double correction, angle, gain = 1.85;
        ...
        correction = correction * P_DRIVE_COEFF_2;
